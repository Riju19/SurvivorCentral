...
let questions = [
  ...
  },
  {
    ...
    // Question 2
    question:
      "Are you a survivor of domestic violence, sexual assault or both?",
  ...
  },
  {
    ...
    question:
      "Did the person who sexually assaulted you have HIV/Aids, or are you unsure of the HIV/Aids status of the person who assaulted you?",
  ...
  },
  {
    ...
    // Question 3
    question:
      "Do you have an open case with the police / Do you have any interest in opening a police report?",
    responseChoices: ["Yes", "No"],
    usersResponse: "",
  },
  {
    ...
    question:
      "If the offender is in custody, or possibly expected to be in custody at some point: Would you like to get immediate updates when the offender's custody status changes?",
    responseChoices: ["Yes", "No"],
    usersResponse: "",
  },
  {
  ...
  },
  {
    ...
    // Question 5
    question:
      "Were children present (anywhere in the household) during any of the incidents?",
    responseChoices: ["Yes", "No"],
    usersResponse: "",
  },
  {
    ...
    question:
      "Were children ever recipients of physical, verbal or emotional abuse?",
    responseChoices: ["Yes", "No"],
    usersResponse: "",
  },
  {
    ...
    // Question 6
    question:
      "Did you ever experience or face threats of physical violence (personal injury, propert damage, etc) OR have a family member pass away from violence?",
    responseChoices: ["Yes", "No"],
    usersResponse: "",
  },
  {
    ...
    question:
      "Have you ever filed a police report within 10 days of the incident?",
    responseChoices: ["Yes", "No"],
    usersResponse: "",
  },
  {
    ...
    question:
      "Would you be interested in potentailly filing a police report? If so, this would make you eligble for up to $25,000 for medical expenses, psychological counseling, relocation aid and more.",
    responseChoices: ["Yes", "No"],
    usersResponse: "",
  },
  {
  ...
  },
  {
    ...
    // Question 8
    question:
      "Would you be interested in free and confidential psychological counseling and therapy resources?",
    responseChoices: ["Yes", "No"],
    usersResponse: "",
  },
  {
  ...
  },
  {
    ...
    // Question 10
    question:
      "Do you fear for your own physical safety (and/or your child's safety) from your abuser, and would you like to legally prevent your abuser from contacting/coming near you?",
    responseChoices: "",
    usersResponse: "",
  },
  {
    ...
    question:
      "Do you currently have an open case with the police / do you have any interest in opening a police report?",
    responseChoices: ["Yes", "No"],
    usersResponse: "",
  },
  {
  ...
  },
  {
    ...
    question:
      "Would you be interested in free legal counseling to evaluate your options and potentially get restitution?",
    responseChoices: ["Yes", "No"],
    usersResponse: "",
  },
  {
  ...
  },
  {
    ...
    question:
      "Would you be interested in having an attorney to sue the offender through a CIVIL case?",
    responseChoices: ["Yes", "No"],
    usersResponse: "",
  },
  {
  ...
  },
  {
    ...
    question:
      "Do you need immediate relocation support to escape any abusive/unsafe situations?",
    responseChoices: ["Yes", "No"],
    usersResponse: "",
  },
  {
...
export default class Questionaire extends Component {
  ...
  onResponse(response) {
    ...
    if ((this.state.index = numberOfQuestions)) {
      ...
      // 2. Redirect the user to the resources page, WITH the resources object
    } else {
